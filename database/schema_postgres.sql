...
CREATE INDEX IF NOT EXISTS idx_vp_district ON voter_profiles(district);
CREATE INDEX IF NOT EXISTS idx_vp_state ON voter_profiles(state);
...
CREATE INDEX IF NOT EXISTS idx_app_ref ON applications(reference_number);
...
CREATE INDEX IF NOT EXISTS idx_ps_district ON polling_stations(district);
...
CREATE INDEX IF NOT EXISTS idx_grv_ref ON grievances(reference_number);
